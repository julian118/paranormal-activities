...
import { AnswerMessage, ClearMessage, InformativeMessage, InputMessage } from "../types/messages.ts"
...
export default class GameController {
  ...
  inputMessage(data: InputMessage) {
    this.gameService.inputMessage(data.message, data.placeholder, data.roomCode, data.playerNameArray)
  }
